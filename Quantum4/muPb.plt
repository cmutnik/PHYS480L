...
set grid
f(x) = m*x+b
fit f(x) "mu.dat" using 4:5 via m,b

g(x) = m1*x+b1
fit g(x) "mu.dat" using 4:6 via m1,b1

plot 'mu.dat' u 4:5 w points ps 2 t '',\
	'mu.dat' using 4:6 w points ps 2 title '',\
