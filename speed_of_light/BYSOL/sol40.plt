...
set out 'solgraph40.png'

set multiplot
set size 1,1
set origin 0,0 #origin of plot
set title "40ns Photon Amplitude"
...
f1(x)=a1*x+b1
fit [500:750] f1(x) "sol.dat" u 1:3 via a1, b1
f2(x)=a2*x+b2
fit [1300:1400] f2(x) "sol.dat" u 1:3 via a2, b2


plot  "sol.dat" using 1:3 title '' lc rgb "blue" lw 3 with points,\
		f1(x),\
		f2(x)
